function func1(){
    ...
    document.getElementById("pp12").textContent ='ש"ח'+ totalpopcorn.toString()+": סך הכל מחיר הפופקורן";
    document.getElementById("pp22").textContent ='ש"ח'+totalNachos.toString()+": סך הכל מחיר נאצוס";
    document.getElementById("pp32").textContent='ש"ח'+ totalPrice.toString() + ": סך הכל מחיר";
